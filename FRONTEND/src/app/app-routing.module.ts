...
import { ErrorComponent } from './DemoPages/UserPages/error/error.component';
import { HeaderComponent } from './Layout/Components/header/header.component';
import { SpringBasicComponent } from './DemoPages/Courses/JavaFrameworks/Spring/spring-basic/spring-basic.component';
import { CollectionComponent } from './DemoPages/Courses/CoreJava/Collection/collection/collection.component';

const routes: Routes = [
  { path: '', redirectTo: '/login', pathMatch: 'full' },
  { path: 'login', component: LoginBoxedComponent },
  {
    // path: 'baseLayout/:name', component: BaseLayoutComponent,
    path: 'u', component: BaseLayoutComponent,
    children: [

      // Dashboads

   
      {path: 'analytics', component: AnalyticsComponent, data: {extraParameter: 'dashboardsMenu'}},
     
     // Core Java
     // Collection
      {path: 'courses/coreJava/collection', component: CollectionComponent, data: {extraParameter: 'collectionMenu'}},
     
      // Java Frameworks
     // Spring
      {path: 'courses/javaFrameworks/spring-basic', component: SpringBasicComponent, data: {extraParameter: 'springMenu'}},
